...
class EADEN:
    def __init__(self, sess, model,lam, batch_size=1, confidence = CONFIDENCE,
        ...
        self.lam = lam
        self.lam_t = tf.cast(self.lam, tf.float32)
        ...
        self.l2dist = tf.multiply(tf.reciprocal(tf.log(tf.reciprocal(tf.reduce_sum(tf.square(self.newimg-self.timg),[1,2,3])))),self.lam_t/tf.log(10.0))
        self.l2dist_y = tf.multiply(tf.reciprocal(tf.log(tf.reciprocal(tf.reduce_sum(tf.square(self.slack-self.timg),[1,2,3])))),self.lam_t/tf.log(10.0))
        #self.l2dist = tf.reciprocal(tf.log(tf.reciprocal(tf.reduce_sum(tf.square(self.newimg-self.timg),[1,2,3]))))
        #self.l2dist_y = tf.reciprocal(tf.log(tf.reciprocal(tf.reduce_sum(tf.square(self.slack-self.timg),[1,2,3]))))
